...
function setDefaultUetConsent() {
  ...
  const consentState =
    config.uetConfig.defaultConsent === "granted" ? "granted" : "denied";
...
const cookieDatabase = {
  _gcl: {
    ...
    duration: "90 days",
    description: "Google Click Identifier - Tracks ad clicks and conversions",
  },
  _gcl_au: {
    category: "advertising",
    duration: "90 days",
  ...
  gclid: {
    category: "advertising",
    duration: "30 days",
    description: "Google Click ID - Tracks PPC ad clicks",
  },
  IDE: {
    category: "advertising",
    duration: "390 days",
    description: "Google DoubleClick - Used for retargeting",
  },
  NID: {
    category: "advertising",
    duration: "180 days",
    description: "Google Ads preferences",
  },
  _gat_gtag: {
    category: "advertising",
    duration: "1 minute",
    description: "Google Tag Manager throttle",
  },
  msclkid: {
    category: "advertising",
    duration: "30 days",
    description: "Microsoft Click ID - Tracks ad clicks",
  },
  _uetmsdns: {
    category: "advertising",
    duration: "Session",
    description: "Microsoft UET consent mode cookie",
  },
  MUID: {
    category: "advertising",
    duration: "390 days",
    description: "Microsoft Universal ID",
  },
  _uetsid: {
    category: "advertising",
    duration: "1 day",
    description: "Bing Ads session ID",
  },
  _uetvid: {
    category: "advertising",
    duration: "390 days",
    description: "Bing Ads visitor ID",
  },
  _fbp: {
    category: "advertising",
    duration: "90 days",
    description: "Facebook Pixel - Conversion tracking",
  },
  fr: {
    category: "advertising",
    duration: "90 days",
  ...
  datr: {
    category: "advertising",
    duration: "730 days",
    description: "Facebook browser identification",
  },
  _ttp: {
    category: "advertising",
    duration: "390 days",
  ...
  tt_sessionid: {
    category: "advertising",
    duration: "1 day",
    description: "TikTok session",
  },
  lidc: {
    category: "advertising",
    duration: "1 day",
    description: "LinkedIn Ads routing",
  },
  bcookie: {
    category: "advertising",
    duration: "730 days",
  ...
  li_sugr: {
    category: "advertising",
    duration: "90 days",
    description: "LinkedIn user tracking",
  },
  _pinterest_ct_ua: {
    category: "advertising",
    duration: "365 days",
    description: "Pinterest Click Tracking",
  },
  _pinterest_sess: {
    category: "advertising",
    duration: "1 day",
    description: "Pinterest session",
  },
  cm_sub: {
    category: "advertising",
    duration: "365 days",
    description: "Pinterest conversion",
  },
  obuid: {
    category: "advertising",
    duration: "365 days",
    description: "Outbrain user ID",
  },
  obcl: {
    category: "advertising",
    duration: "30 days",
    description: "Outbrain click tracking",
  },
  personalization_id: {
    category: "advertising",
    duration: "730 days",
    description: "Twitter personalization",
  },
  guest_id: {
    category: "advertising",
    duration: "730 days",
    description: "Twitter guest tracking",
  },
  sc_at: {
    category: "advertising",
    duration: "365 days",
  ...
  _scid: {
    category: "advertising",
    duration: "365 days",
    description: "Snapchat user ID",
  },
  rdt_uuid: {
    category: "advertising",
    duration: "365 days",
    description: "Reddit unique user ID",
  },
  session_tracker: {
    category: "advertising",
    duration: "1 day",
    description: "Reddit session",
  },
  criteo: {
    category: "advertising",
    duration: "365 days",
    description: "Criteo retargeting",
  },
  uid: {
    category: "advertising",
    duration: "365 days",
    description: "Criteo user ID",
  },
  __adroll: {
    category: "advertising",
    duration: "365 days",
    description: "AdRoll tracking",
  },
  __ar_v4: {
    category: "advertising",
    duration: "365 days",
    description: "AdRoll segmentation",
  },
  "ad-id": {
    category: "advertising",
    duration: "270 days",
    description: "Amazon Ad System ID",
  },
  "ad-privacy": {
    category: "advertising",
    duration: "730 days",
    description: "Amazon Ad Preferences",
  },
  yandexuid: {
    category: "advertising",
    duration: "365 days",
    description: "Yandex Metrica user ID",
  },
  ymex: {
    category: "advertising",
    duration: "365 days",
    description: "Yandex Metrica visitor",
  },
  "m-b": {
    category: "advertising",
    duration: "365 days",
    description: "Quora browser ID",
  },
  "m-uid": {
    category: "advertising",
    duration: "365 days",
    description: "Quora user ID",
  },
  sadb: {
    category: "advertising",
    duration: "30 days",
    description: "StackAdapt bidding data",
  },
  sadr: {
    category: "advertising",
    duration: "30 days",
    description: "StackAdapt retargeting",
  },
  TDID: {
    category: "advertising",
    duration: "365 days",
  ...
  TDCPM: {
    category: "advertising",
    duration: "365 days",
    description: "The Trade Desk CPM data",
  },
  mmapi: {
    category: "advertising",
    duration: "30 days",
    description: "MediaMath API tracking",
  },
  mmdata: {
    category: "advertising",
    duration: "30 days",
    description: "MediaMath campaign data",
  },
  _ga: {
    category: "analytics",
    duration: "730 days",
  ...
  _gat: {
    category: "analytics",
    duration: "1 minute",
    description: "Google Analytics throttle",
  },
  PHPSESSID: {
    category: "functional",
    duration: "Session",
  ...
  lu: {
    ...
    duration: "2 years",
    description:
      "Used to record whether the person chose to remain logged in (User ID and miscellaneous log in information)",
  },
  xs: {
    category: "advertising",
    duration: "90 days",
    description:
      "Used with c_user cookie to authenticate identity to Facebook (Session ID, creation time, authentication value)",
  },
  c_user: {
    category: "advertising",
    duration: "90 days",
    description:
      "Used with xs cookie to authenticate identity to Facebook (User ID)",
  },
  m_user: {
    category: "advertising",
    duration: "90 days",
    description:
      "Used to authenticate identity on Facebook mobile website (Email, User ID, authentication value)",
  },
  pl: {
    category: "advertising",
    duration: "90 days",
    description:
      "Records that a device or browser logged in via Facebook platform",
  },
  dbln: {
    category: "advertising",
    duration: "2 years",
    description:
      "Used to enable device-based logins (Login authentication values)",
  },
  aks: {
    category: "advertising",
    duration: "30 days",
    description:
      "Determines login state of a person visiting accountkit.com (Account kit access token)",
  },
  aksb: {
    category: "advertising",
    duration: "30 minutes",
    description: "Authenticates logins using Account Kit (Request time value)",
  },
  sfau: {
    category: "advertising",
    duration: "1 day",
    description:
      "Optimizes recovery flow after failed login attempts (Encrypted user ID, contact point, time stamp)",
  },
  ick: {
    category: "advertising",
    duration: "2 years",
  ...
  s: {
    ...
    duration: "90 days",
    description:
      "Facebook browser identification, authentication, marketing cookies",
  },
  sb: {
    category: "advertising",
    duration: "2 years",
  ...
  _fbc: {
    ...
    duration: "2 years",
    description:
      "Used for Facebook advertising products like real time bidding",
  },
  oo: {
    category: "advertising",
    duration: "5 years",
    description: "Ad opt-out cookie",
  },
  ddid: {
    category: "advertising",
    duration: "28 days",
    description:
      "Used to open specific location in advertiser app upon installation",
  },
  locale: {
    category: "advertising",
    duration: "7 days",
    description: "Contains display locale of last logged in user",
  },
  js_ver: {
    category: "advertising",
    duration: "7 days",
    description: "Records age of Facebook javascript files",
  },
  rc: {
    category: "advertising",
    duration: "7 days",
  ...
  campaign_click_url: {
    category: "advertising",
    duration: "30 days",
    description: "Records Facebook URL landed on after clicking an ad",
  },
  usida: {
    category: "advertising",
    duration: "Session",
    description:
      "Collects browser and unique identifier for targeted advertising",
  },
  wd: {
    category: "functional",
    duration: "Session",
    description:
      "Stores browser window dimensions for page rendering optimization",
  },
  presence: {
    category: "functional",
    duration: "Session",
    description: "Contains user chat state",
  },
};
...
const translations = {
  en: {
    ...
    description:
      "We use cookies to ensure that we give you best experience on our website. If you continue to use this site we will assume that you are happy with it.",
  ...
  fr: {
    ...
    description:
      'Nous utilisons des cookies pour améliorer votre expérience, fournir des publicités ou du contenu personnalisé et analyser notre trafic. En cliquant sur "Tout accepter", vous consentez à l\'utilisation de cookies.',
  ...
  de: {
    ...
    description:
      'Wir verwenden Cookies, um Ihr Surferlebnis zu verbessern, personalisierte Anzeigen oder Inhalte bereitzustellen und unseren Datenverkehr zu analysieren. Wenn Sie auf "Alle akzeptieren" klicken, erklären Sie sich mit der Verwendung von Cookies einverstanden.',
  ...
  it: {
    ...
    description:
      'Utilizziamo i cookie per migliorare la tua esperienza, fornire annunci o contenuti personalizzati e analizzare il nostro traffico. Cliccando su "Accetta tutto", acconsenti all\'uso dei cookie.',
    privacy: "Privacy Policy",
  ...
  es: {
    ...
    description:
      'Utilizamos cookies para mejorar su experiencia, proporcionar anuncios o contenido personalizado y analizar nuestro tráfico. Al hacer clic en "Aceptar todo", usted acepta el uso de cookies.',
  ...
  pt: {
    ...
    description:
      'Usamos cookies para melhorar sua experiência, fornecer anúncios ou conteúdo personalizado e analisar nosso tráfego. Clicando em "Aceitar Tudo", você concorda com o uso de cookies.',
  ...
  nl: {
    ...
    description:
      'We gebruiken cookies om uw browse-ervaring te verbeteren, gepersonaliseerde advertenties of inhoud te bieden en ons verkeer te analyseren. Door op "Alles accepteren" te klikken, stemt u in met het gebruik van cookies.',
  ...
  pl: {
    ...
    description:
      'Używamy plików cookie, aby poprawić Twoje doświadczenia przeglądania, dostarczać spersonalizowane reklamy lub treści i analizować nasz ruch. Klikając „Zaakceptuj wszystkie", wyrażasz zgodę na używanie plików cookie.',
  ...
  sv: {
    ...
    description:
      'Vi använder cookies för att förbättra din surfupplevelse, tillhandahålla anpassade annonser eller innehåll och analysera vår trafik. Genom att klicka på "Acceptera alla" samtycker du till användningen av cookies.',
  ...
  da: {
    ...
    description:
      'Vi bruger cookies til at forbedre din browsingoplevelse, levere personificerede annoncer eller indhold og analysere vores trafik. Ved at klikke på "Accepter alle" giver du samtykke til brugen af cookies.',
    ...
    description:
      'Käytämme evästeitä parantaaksemme selauskokemustasi, tarjotaksemme henkilökohtaisia mainoksia tai sisältöä ja analysoidaksemme liikennettämme. Klikkaamalla "Hyväksy kaikki" annat suostumuksesi evästeiden käyttöön.',
  ...
  el: {
    ...
    description:
      'Χρησιμοποιούμε cookies για να βελτιώσουμε την εμπειρία σας, να παρέχουμε εξατομικευμένες διαφημίσεις ή περιεχόμενο και να αναλύουμε την επισκεψιμότητά μας. Κάνοντας κλικ στο "Αποδοχή όλων", συναινείτε στη χρήση cookies.',
  ...
  hu: {
    ...
    description:
      'Cookie-kat használunk a böngészési élmény javításához, személyre szabott hirdetések vagy tartalom nyújtásához és a forgalmunk elemzéséhez. Az "Összes elfogadása" gombra kattintva hozzájárul a cookie-k használatához.',
  ...
  cs: {
    ...
    description:
      'Používáme cookies ke zlepšení vašeho zážitku z prohlížení, poskytování personalizovaných reklam nebo obsahu a analýze našeho provozu. Kliknutím na "Přijmout vše" souhlasíte s používáním cookies.',
  ...
  ro: {
    ...
    description:
      'Folosim cookie-uri pentru a îmbunătăți experiența de navigare, pentru a furniza reclame sau conținut personalizat și pentru a analiza traficul nostru. Făcând clic pe "Acceptă tot", sunteți de acord cu utilizarea cookie-urilor.',
  ...
  sk: {
    ...
    description:
      'Používame cookies na zlepšenie vášho zážitku z prehliadania, poskytovanie personalizovaných reklám alebo obsahu a analýzu nášho prevádzky. Kliknutím na "Prijať všetko" súhlasíte s používaním súborov cookie.',
  ...
  sl: {
    ...
    description:
      'Uporabljamo piškotke za izboljšanje vaše izkušnje brskanja, zagotavljanje prilagojenih oglasov ali vsebin in analizo našega prometa. S klikom na "Sprejmi vse" se strinjate z uporabo piškotkov.',
  ...
  bg: {
    ...
    description:
      'Използваме бисквитки, за да подобрим вашето сърфиране, да предоставяме персонализирани реклами или съдържание и да анализираме нашия трафик. С натискане на "Приеми всички" вие се съгласявате с използването на бисквитки.',
  ...
  hr: {
    ...
    description:
      'Koristimo kolačiće za poboljšanje vašeg iskustva pregledavanja, pružanje personaliziranih oglasa ili sadržaja i analizu našeg prometa. Klikom na "Prihvati sve" pristajete na korištenje kolačića.',
  ...
  lt: {
    ...
    description:
      'Mes naudojame slapukus, kad pagerintume jūsų naršymo patirtį, teiktume suasmenintas reklamas ar turinį ir analizuotume savo srautą. Spustelėję "Priimti viską" sutinkate su slapukų naudojimu.',
  ...
  lv: {
    ...
    description:
      'Mēs izmantojam sīkfailus, lai uzlabotu jūsu pārlūkošanas pieredzi, nodrošinātu personalizētus reklāmas vai saturu un analizētu mūsu satiksmi. Noklikšķinot uz "Piekrist visiem", jūs piekrītat sīkfailu izmantošanai.',
  ...
  et: {
    ...
    description:
      'Kasutame küpsiseid, et parandada teie veebilehitsemise kogemust, pakkuda personaalseid reklaame või sisu ning analüüsida oma liiklust. Klõpsates nupul "Nõustu kõigega", nõustute küpsiste kasutamisega.',
  ...
  mt: {
    ...
    description:
      "Nużaw cookies biex ittejjeb l-esperjenza tiegħek ta 'navigazzjoni, nipprovdu reklami jew kontent personalizzat u nanalizzaw it-traffiku tagħna. Billi tikklikkja \"Aċċetta Kollox\", qed tagħti l-kunsens għall-użu ta 'cookies.",
...
function generateAnalyticsDashboard(language = "en") {
  ...
  const acceptedPercent =
    total > 0 ? Math.round((consentAnalytics.total.accepted / total) * 100) : 0;
  const rejectedPercent =
    total > 0 ? Math.round((consentAnalytics.total.rejected / total) * 100) : 0;
  const customPercent =
    total > 0 ? Math.round((consentAnalytics.total.custom / total) * 100) : 0;
  ...
  const last7Days = {};
  const dates = Object.keys(consentAnalytics.daily)
    .sort()
    .reverse()
    .slice(0, 7);
  dates.forEach((date) => {
  ...
  const last30Days = {};
  const monthlyDates = Object.keys(consentAnalytics.daily)
    .sort()
    .reverse()
    .slice(0, 30);
    ...
    <div class="analytics-dashboard">
        ...
        <div class="time-based-stats">
            <div class="time-stat">
                ...
                <div class="stat-bars">
                    ${Object.entries(last1Day)
                      .map(([date, data]) => {
                        const dayTotal =
                          data.accepted + data.rejected + data.custom;
                        const dayAcceptedPercent =
                          dayTotal > 0 ? (data.accepted / dayTotal) * 100 : 0;
                        const dayRejectedPercent =
                          dayTotal > 0 ? (data.rejected / dayTotal) * 100 : 0;
                        const dayCustomPercent =
                          dayTotal > 0 ? (data.custom / dayTotal) * 100 : 0;
...
function checkGeoTargeting(geoData) {
  ...
  if (
    config.geoConfig.allowedCountries.length > 0 &&
...
function getAvailableLanguages() {
  if (config.languageConfig.availableLanguages.length > 0) {
    return config.languageConfig.availableLanguages.filter(
...
function changeLanguage(languageCode) {
  ...
  if (banner) {
    ...
    banner.querySelector(".main-privacy-policy-link").textContent =
      lang.privacy;
  ...
  if (dashboardModal && dashboardModal.style.display === "flex") {
    if (config.analytics.passwordProtect && !isDashboardAuthenticated) {
      dashboardModal.querySelector(".cookie-analytics-body").innerHTML =
        generatePasswordPrompt(languageCode);
      setupPasswordPromptEvents();
    } else {
      dashboardModal.querySelector(".cookie-analytics-body").innerHTML =
        generateAnalyticsDashboard(languageCode);
    }
  }
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="cookie-value-cell">
                    <span class="cookie-value-full" style="display:none;">${
                      cookie.value
                    }</span>
                    <span class="cookie-value-truncated">${cookie.value.substring(
                      0,
                      20
                    )}${cookie.value.length > 20 ? "..." : ""}</span>
                    ${
                      cookie.value.length > 20
                        ? '<button class="toggle-cookie-value" data-state="truncated">Show full</button>'
                        : ""
                    }
                </td>
...
function injectConsentHTML(detectedCookies, language = "en") {
        ...
        <select id="cookieLanguageSelect">
            ${availableLanguages
              .map(
                ...
                }>${translations[code].language}</option>
            `
              )
              .join("")}
        </select>
  ...
  const adminButton =
    ...
    config.analytics.showDashboard &&
    config.behavior.showAdminButton
      ? `
  ...
  const html = `
    ...
    <div id="cookieConsentBanner" class="cookie-consent-banner">
        <div class="cookie-consent-container">
            ...
            <div class="main-cookie-consent-content">
                ...
                }" class="main-privacy-policy-link">${lang.privacy}</a>
            </div>
            <div class="all-cookie-consent-buttons">
                <button id="acceptAllBtn" class="cookie-btn main-accept-button">${
                  lang.accept
                }</button>
                <button id="rejectAllBtn" class="cookie-btn top-reject-btn">${
                  lang.reject
                }</button>
                <button id="adjustConsentBtn" class="cookie-btn top-adjust-button">${
                  lang.customize
                }</button>
            </div>
        </div>
            ...
            <div class="cookie-settings-footer">
                ...
                <div class="see-analytics-container">
                 ...
                 <div class="modal-buttons-container">
                    <button id="acceptAllSettingsBtn" class="cookie-btn main-accept-button">${
                      lang.accept
                    }</button>
                    <button id="saveSettingsBtn" class="cookie-btn main-save-btn">${
                      lang.save
                    }</button>
                    <button id="rejectAllSettingsBtn" class="cookie-btn top-adjust-button">${
                      lang.reject
                    }</button>
                </div>
            </div>
    ...
    <div id="cookieFloatingButton" class="cookie-settings-button" title="${
      lang.title
    }">
...
function shouldShowBanner() {
  ...
  if (config.behavior.bannerSchedule.durationDays) {
    ...
    if (!firstVisit) {
      setCookie(
        "first_visit_date",
        currentDate,
        config.behavior.bannerSchedule.durationDays
      );
      return true;
    }
    ...
    endDate.setDate(
      endDate.getDate() + config.behavior.bannerSchedule.durationDays
    );
  ...
  const startTime =
    parseInt(config.behavior.bannerSchedule.startTime.split(":")[0]) * 100 +
    parseInt(config.behavior.bannerSchedule.startTime.split(":")[1]);
  const endTime =
    parseInt(config.behavior.bannerSchedule.endTime.split(":")[0]) * 100 +
  ...
  if (
    config.behavior.bannerSchedule.daysOfWeek.length > 0 &&
...
function initializeCookieConsent(detectedCookies, language) {
  ...
  if (
    config.behavior.bannerSchedule.enabled &&
    config.behavior.bannerSchedule.durationMinutes
  ) {
    if (bannerTimer) {
    ...
    passwordSubmit.addEventListener("click", function () {
      ...
      if (passwordInput.value === config.analytics.dashboardPassword) {
        ...
        setCookie(
          "dashboard_auth",
          "true",
          config.analytics.passwordCookieDuration
        );

        document.querySelector(".cookie-analytics-body").innerHTML =
          generateAnalyticsDashboard(lang);
      } else {
...
function setupEventListeners() {
  ...
  document
    .getElementById("adjustConsentBtn")
    .addEventListener("click", function () {
      showCookieSettings();
      hideCookieBanner();
    });
  ...
  document
    .getElementById("acceptAllSettingsBtn")
    .addEventListener("click", function () {
      acceptAllCookies();
      hideCookieSettings();
      if (config.behavior.showFloatingButton) {
  ...
  document
    .getElementById("rejectAllSettingsBtn")
    .addEventListener("click", function () {
      rejectAllCookies();
      hideCookieSettings();
      if (config.behavior.showFloatingButton) {
  ...
  document
    .querySelector(".close-analytics-modal")
    .addEventListener("click", function () {
      hideAnalyticsDashboard();
    });

  document
    .getElementById("cookieFloatingButton")
    .addEventListener("click", function () {
      if (
        !document
...
function saveCustomSettings() {
  ...
  const advertisingChecked = document.querySelector(
    'input[data-category="advertising"]'
  ).checked;
  ...
  const consentData = {
    ...
    categories: {
      ...
      performance: document.querySelector('input[data-category="performance"]')
        .checked,
      advertising: advertisingChecked,
      uncategorized: document.querySelector(
        'input[data-category="uncategorized"]'
      )
        ? document.querySelector('input[data-category="uncategorized"]').checked
        : false,
    },
    timestamp: new Date().getTime(),
  };
  ...
  const consentStates = {
    ...
    ad_personalization: consentData.categories.advertising
      ? "granted"
      : "denied",
    personalization_storage: consentData.categories.performance
      ? "granted"
      : "denied",
...
function updateConsentMode(consentData) {
  ...
  if (config.uetConfig.enabled) {
    const uetConsentState = consentData.categories.advertising
      ? "granted"
      : "denied";
